...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:+cRmVBz3H/U19fwW85uY+vS+EweAj7cPdhlP4b7vrE4=",
        version = "v1.1.1-0.20190513200039-d13326f0be73",
    )
    go_repository(
        name = "com_github_olivere_elastic_v7",
        importpath = "github.com/olivere/elastic/v7",
        sum = "h1:BIzjaAYGL8Ur1pIPIpiYDvly4HkHrO/uakiV22WDEQQ=",
        version = "v7.0.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jYtUO4wwP7psAweisP/MDoOpdzsYEESdoPcsWjHDR68=",
        version = "v0.21.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/KIG00BzA2x2HRStX2tnhbqbQdPcFlkgsYCiNY20FZs=",
        version = "v0.21.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_aeden_traceroute",
        importpath = "github.com/aeden/traceroute",
        sum = "h1:LbPChgmEVYTHVg0zmAydDO3YNRgkt31svsI7LJ0crjs=",
        version = "v0.0.0-20181124220833-147686d9cb0f",
    )
    go_repository(

...
int ngap_amf_handle_ue_context_release_request(ngap_state_t* state,
  ...
  if (ie) {
    ...
    OAILOG_ERROR(LOG_NGAP,
                  "UE CONTEXT RELEASE REQUEST invoked with missing Ngap_UEContextReleaseRequest_IEs (RAN_UE_NGAP_ID). Unable to process the message.\n");
    OAILOG_FUNC_RETURN(LOG_NGAP, RETURNerror);
  }
  ...
  if (ie) {
    ...
    OAILOG_ERROR(LOG_NGAP,
                  "UE CONTEXT RELEASE REQUEST invoked with missing Ngap_UEContextReleaseRequest_IEs (Cause). Unable to process the message.\n");
    OAILOG_FUNC_RETURN(LOG_NGAP, RETURNerror);
  }
  switch (cause_type) {
    case Ngap_Cause_PR_radioNetwork:
